...
namespace Microsoft.Azure.Databricks.Client.Test
{
    ...
    {
        public static readonly Uri ClusterApiUri = new(BaseApiUri, "2.0/clusters/");

        [TestMethod]
        public async Task TestCreateFixedWorker()
        {
            var apiUri = new Uri(ClusterApiUri, "create");
            var expectedRequest = """{"cluster_name": "my-cluster","spark_version": "7.3.x-scala2.12","node_type_id": "Standard_D3_v2","spark_conf": {"spark.speculation": "true"},"num_workers": 25}""";
            ...
            var clusterInfo = ClusterInfo.GetNewClusterConfiguration("my-cluster")
        ...
        {
            var apiUri = new Uri(ClusterApiUri, "create");
            var expectedRequest = """{"cluster_name":"autoscaling-cluster","spark_version":"7.3.x-scala2.12","node_type_id":"Standard_D3_v2","autoscale":{"min_workers":2,"max_workers":50}}""";
            ...
            using var client = new ClustersApiClient(hc);
            var clusterInfo = ClusterInfo.GetNewClusterConfiguration("autoscaling-cluster")
                .WithNodeType("Standard_D3_v2")
                .WithAutoScale(2, 50)
                .WithRuntimeVersion(RuntimeVersions.Runtime_7_3);
        ...
        {
            var apiUri = new Uri(ClusterApiUri, "create");
            var expectedRequest = """{"cluster_name":"single-node-cluster","spark_version":"7.3.x-scala2.12","node_type_id":"Standard_D3_v2","num_workers":0,"spark_conf":{"spark.databricks.cluster.profile":"singleNode","spark.master":"local[*]"},"custom_tags":{"ResourceClass":"SingleNode"}}""";
            ...
            using var client = new ClustersApiClient(hc);
            var clusterInfo = ClusterInfo.GetNewClusterConfiguration("single-node-cluster")
                .WithNodeType("Standard_D3_v2")
        ...
        {
            var idempotencyToken = "test_idempotency_token";
            var apiUri = new Uri(ClusterApiUri, "create");
            var expectedRequest = """
            {
            ...
            string clusterId = await client.Create(clusterAttributes, idempotencyToken);
            Assert.AreEqual(expectedResponse.cluster_id, clusterId);
        ...
        public async Task TestEdit()
        {
            ...
            var expectedRequest = """{"cluster_id":"1202-211320-brick1","num_workers":10,"spark_version":"7.3.x-scala2.12","node_type_id":"Standard_D3_v2"}""";
        ...
        public async Task TestStart()
        {
            ...
            var expectedRequest = """{"cluster_id":"1234-567890-reef123"}""";
            var handler = CreateMockHandler();
            handler
                .SetupRequest(HttpMethod.Post, apiUri)
                .ReturnsResponse(HttpStatusCode.OK);
        ...
        public async Task TestResize()
        {
            ...
            var expectedRequest = """{"cluster_id":"1234-567890-reef123","num_workers":30}""";
            var handler = CreateMockHandler();
            handler
                .SetupRequest(HttpMethod.Post, apiUri)
                .ReturnsResponse(HttpStatusCode.OK);
        ...
        public async Task TestTerminate()
        {
            ...
            var expectedRequest = """{"cluster_id":"1234-567890-frays123"}""";
            var handler = CreateMockHandler();
            handler
                .SetupRequest(HttpMethod.Post, apiUri)
                .ReturnsResponse(HttpStatusCode.OK);
        ...
        public async Task TestGet()
        {
            ...
            var expectedResponse = """
                {"cluster_id":"1234-567890-reef123","driver":{"node_id":"dced0ce388954c38abef081f54c18afd","instance_id":"c69c0b119a2a499d8a2843c4d256136a",
                "start_timestamp":1619718438896,"host_private_ip":"10.0.0.1","private_ip":"10.0.0.2"},"spark_context_id":5631707659504820000,"jdbc_port":10000,
                "cluster_name":"my-cluster","spark_version":"8.2.x-scala2.12","node_type_id":"Standard_L4s","driver_node_type_id":"Standard_L4s",
                "autotermination_minutes":0,"enable_elastic_disk":true,"disk_spec":{},"cluster_source":"UI","enable_local_disk_encryption":false,
                "azure_attributes":{"first_on_demand":1,"availability":"ON_DEMAND_AZURE","spot_bid_max_price":-1},"instance_source":{"node_type_id":"Standard_L4s"},
                "driver_instance_source":{"node_type_id":"Standard_L4s"},"state":"RUNNING","state_message":"","start_time":1610745129764,
                "last_state_loss_time":1619718513513,"num_workers":0,"cluster_memory_mb":32768,"cluster_cores":4,"creator_user_name":"someone@example.com",
                "pinned_by_user_name":"3401478490056118","init_scripts_safe_mode":false}
                """;
        ...
        public async Task TestList()
        {
            ...
            var expectedResponse = """
                {"clusters":[{"cluster_id":"1234-567890-reef123","driver":{"node_id":"dced0ce388954c38abef081f54c18afd","instance_id":"c69c0b119a2a499d8a2843c4d256136a","start_timestamp":1619718438896,"host_private_ip":"10.0.0.1","private_ip":"10.0.0.2"},"spark_context_id":5631707659504820000,"jdbc_port":10000,"cluster_name":"my-cluster","spark_version":"8.2.x-scala2.12","node_type_id":"Standard_L4s","driver_node_type_id":"Standard_L4s","autotermination_minutes":0,"enable_elastic_disk":true,"disk_spec":{},"cluster_source":"UI","enable_local_disk_encryption":false,"azure_attributes":{"first_on_demand":1,"availability":"ON_DEMAND_AZURE","spot_bid_max_price":-1},"instance_source":{"node_type_id":"Standard_L4s"},"driver_instance_source":{"node_type_id":"Standard_L4s"},"state":"RUNNING","state_message":"","start_time":1610745129764,"last_state_loss_time":1619718513513,"num_workers":0,"cluster_memory_mb":32768,"cluster_cores":4,"creator_user_name":"someone@example.com","pinned_by_user_name":"3401478490056118","init_scripts_safe_mode":false}]}
                """;
        ...
        public async Task TestListNodeTypes()
        {
            ...
            var expectedResponse = """
                {"node_types":[{"node_type_id":"Standard_L80s_v2","memory_mb":655360,"num_cores":80,"description":"Standard_L80s_v2","instance_type_id":"Standard_L80s_v2","is_deprecated":false,"category":"Storage Optimized","support_ebs_volumes":true,"support_cluster_tags":true,"num_gpus":0,"node_instance_type":{"instance_type_id":"Standard_L80s_v2","local_disks":1,"local_disk_size_gb":800,"instance_family":"Standard LSv2 Family vCPUs","local_nvme_disk_size_gb":1788,"local_nvme_disks":10,"swap_size":"10g"},"is_hidden":false,"support_port_forwarding":true,"display_order":0,"is_io_cache_enabled":true,"node_info":{"available_core_quota":350,"total_core_quota":350}}]}
                """;
        ...
        public async Task TestListSparkVersions()
        {
            ...
            var expectedResponse = """
                {"versions":[{"key":"8.2.x-scala2.12","name":"8.2 (includes Apache Spark 3.1.1, Scala 2.12)"},{"key":"10.4.x-scala2.12","name":"10.4 (includes Apache Spark 3.2.1, Scala 2.12)"}]}
                """;
